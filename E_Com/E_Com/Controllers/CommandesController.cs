...
namespace E_Com.Controllers
{
    public class CommandesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Commande.Include(c => c.article);
        ...
        public async Task<IActionResult> Create([Bind("commandeID,dateCommande,address,quantite,articleID")] Commande commande)
        {
            ...
            ViewData["articleID"] = new SelectList(_context.Article, "articleID", "articleID", commande.articleID);
            return View(commande);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("commandeID,dateCommande,address,quantite,articleID")] Commande commande)
        {
